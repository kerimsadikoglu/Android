...
import com.example.kotlindeneme.databinding.ActivityArtBinding
...
class ArtActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (info.equals("new")) {
            ...
            binding.imageView11.setImageBitmap(selectedImageBackground)
                ...
                if (intentFromResult != null){
                    ...
                    try {
                        if (Build.VERSION.SDK_INT >= 28){
                            ...
                            binding.imageView11.setImageBitmap(selectedBitmap)
                        }else{
